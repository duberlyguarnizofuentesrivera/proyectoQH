...
total.forEach(function (s, e) {
    ...
    l.style.padding = "0px", l.style.width = s.querySelector("li:nth-child(1)").offsetWidth + "px", l.style.transform = "translate3d(0px, 0px, 0px)", l.style.transition = ".5s ease", s.onmouseover = function (e) {
        let t = getEventTarget(e), a = t.closest("li");
        if (a) {
    ...
    total.forEach(function (n, e) {
        ...
        if (s) {
            ...
            if (n.classList.contains("flex-column")) {
                for (var l = 1; l <= e.indexOf(s); l++) t += n.querySelector("li:nth-child(" + l + ")").offsetHeight;
                i.style.transform = "translate3d(0px," + t + "px, 0px)", i.style.width = n.querySelector("li:nth-child(" + a + ")").offsetWidth + "px", i.style.height = n.querySelector("li:nth-child(" + l + ")").offsetHeight
            } else {
                for (l = 1; l <= e.indexOf(s); l++) t += n.querySelector("li:nth-child(" + l + ")").offsetWidth;
                i.style.transform = "translate3d(" + t + "px, 0px, 0px)", i.style.width = n.querySelector("li:nth-child(" + a + ")").offsetWidth + "px"
            }
        }
